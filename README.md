...
Update existing EKS information to this new EC2 instance. Otherwise, this new EC2 instance cannot access the existing eks cluster by following command. Replace <your-cluster-name> with `gcd` and replace <your-region-code> with `us-east-2` for example.
