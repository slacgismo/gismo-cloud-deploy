...
from project.users.tasks import sample_task, task_process_notification, task_send_welcome_email  # updated
...
def transaction_celery():
    ...
    # for user in users:
    #     current_app.logger.info(f'user email:  {user.email} userid: {user.id}')
    # return "done"
