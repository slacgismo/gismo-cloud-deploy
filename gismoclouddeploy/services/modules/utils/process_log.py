...
def analyze_all_local_logs_files(
    ...
    if len(average_task_duration) > 1 :
        ...
        std_of_task_duration_in_parallelism =  statistics.mean(task_duration_in_parallelism[1:])
        ...
        mean_of_initial_process_time =  statistics.mean(init_process_time_list)
        std_of_initial_process_time =  statistics.mean(init_process_time_list)
        initial_process_time = initial_process_time + init_process_time_list

        initial_process_time.append(mean_of_initial_process_time)
        initial_process_time.append(std_of_initial_process_time)
        mean_of_total_process_time =  statistics.mean(total_proscee_time_list)
        std_of_total_process_time =  statistics.mean(total_proscee_time_list)
        ...
        std_of_effeciencyFactor =  statistics.mean(effeciencyFactor[1:])
